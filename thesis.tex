...
% \usepackage[style=unitartucs-authoryear,uniquename=init]{biblatex} % Author-year citations (Koit 2010), alphabetically sorted bibliography.
...
\input{sections/references-citations}
\input{sections/data}
